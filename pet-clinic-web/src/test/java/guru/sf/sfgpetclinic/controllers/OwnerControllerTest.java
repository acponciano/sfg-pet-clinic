...
public class OwnerControllerTest {
    ...
    @Test
    public void shouldProcessCreationForm() throws Exception {
    ...
    @Test
    public void shouldInitUpdateForm() throws Exception {
    ...
    @Test
    public void shouldProcessUpdateForm() throws Exception {
